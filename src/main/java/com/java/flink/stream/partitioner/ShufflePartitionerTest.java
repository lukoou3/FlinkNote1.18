...
public class ShufflePartitionerTest {
    ...
    /**
     * shuffle后，下游的流和前面的分开，这个容易理解，因为上游task的每个元素要向下游所有task发送
     * RecordWriterOutput的RecordWriter recordWriter 属性类型是ChannelSelectorRecordWriter， numberOfChannels就是下游并行度
     * ChannelSelectorRecordWriter的channelSelector类型是ShufflePartitioner
     */
    @Test
    public void testShuffle() throws Exception{
        ...
        DataStream<Tuple2<Integer, String>> twoDs = oneDs.shuffle();
