...
public class BroadcastPartitionerTest {
    static final Logger LOG = LoggerFactory.getLogger(BroadcastPartitionerTest.class);

    /**
     * broadcast后，下游的流和前面的分开，这个容易理解，因为上游task的每个元素要向下游所有task发送
     * RecordWriterOutput的RecordWriter recordWriter 属性类型是BroadcastRecordWriter， numberOfChannels就是下游并行度
     */
    @Test
    public void testBroadcast() throws Exception{
        ...
        DataStream<Tuple2<Integer, String>> twoDs = oneDs.broadcast();
        ...
        env.execute("BroadcastPartitionerTest");
    }
